...
function noteSelectFunction(clicked) {
	...
	switch (clicked) {
	  ...
	  case "New Scada Alarm":
		...
		alertPrompt(blanksArray);
		var tempInput = document.createElement("textarea");
        	tempInput.value = "<strong><font color='#ff0000'>"+ blanksArrayAnswered[0] +"</font></strong><p>"+ blanksArrayAnswered[1] +"</p>";
        	document.body.appendChild(tempInput);
        	tempInput.select();
        	document.execCommand("copy");
        	document.body.removeChild(tempInput);
	...
	break;
	  case "snapSendSolveAlreadyLoggedCaseNotes":
		...
		alertPrompt(blanksArray);
		var tempInput = document.createElement("textarea");
        	tempInput.value = "SnapSendSolve sent in reporting same fault. Advised job is already in system and scheduled for repairs - ("+ blanksArrayAnswered[0] +", "+ blanksArrayAnswered[1] +")";
        	document.body.appendChild(tempInput);
        	tempInput.select();
        	document.execCommand("copy");
        	document.body.removeChild(tempInput);
	...
	break;
      ...
      case "webformAlreadyLoggedCaseNotes":
		...
		alertPrompt(blanksArray);
      	var tempInput = document.createElement("textarea");
        tempInput.value = "Webform sent in reporting same fault. Advised job is already in system and scheduled for repairs - ("+ blanksArrayAnswered[0] +", "+ blanksArrayAnswered[1] +")";
        document.body.appendChild(tempInput);
        tempInput.select();
        document.execCommand("copy");
        document.body.removeChild(tempInput);
	...
	case "waterOffWorkSheet":
		...
		alertPrompt(blanksArray);
		var tempInput = document.createElement("textarea");
        tempInput.value = "Greater Western Water is currently undertaking repairs at "+ blanksArrayAnswered[0] +". This is affecting the supply of water to "+ blanksArrayAnswered[1] +". We are rectifying the situation and expect that the water will be restored by "+ blanksArrayAnswered[2] +". If you require emergency water, you can see our crew onsite at: "+ blanksArrayAnswered[3] +". Thank you for calling Greater Western Water";
        document.body.appendChild(tempInput);
        tempInput.select();
        document.execCommand("copy");
        document.body.removeChild(tempInput);
	...
	case "redBoldScada":
		...
		alertPrompt(blanksArray);
		var tempInput = document.createElement("textarea");
        tempInput.value = "<strong><font color='#ff0000'>"+ blanksArrayAnswered[0] +"</font></strong><p>"+ blanksArrayAnswered[1] +"Issued </p>";
        document.body.appendChild(tempInput);
        tempInput.select();
        document.execCommand("copy");
        document.body.removeChild(tempInput);
